    ...
    {   
        ...
        {   
            ...
            if (currentCard.color == UnoColor.Wild)
            {
                ...
                if (lastCardData.value == UnoValue.WildDrawFour && state.isDrawFourActive && currentCard.value != UnoValue.WildDrawFour) {
                    return false;
                }

                // Restrict Wilds from being played if a Draw Two is active
                else if (lastCardData.value == UnoValue.DrawTwo && state.isDrawTwoActive && currentCard.value != UnoValue.DrawTwo) {
                    return false;
                }
                return true;
            }
            ...
            if (lastCardData.value == UnoValue.WildDrawFour) {
                if (state.isDrawFourActive) {
                    ...
                    // Debug.Log("test B");
                    return (int)currentCard.color == state.CurrentColor;
                }
            }
